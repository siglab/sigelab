...
import { CovidNewsComponent } from "../modulos/mod-principal/covid-news/covid-news.component";
...
const routes: Routes = [
  ...
  { path: "registro", component: RegistroComponent },
  {
    ...
    children: [
      { path: "noticias", component: CovidNewsComponent },
      ...
      {
        path: "adminlaboratorios",
        component: AdminLaboratoriosComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminequipos",
        component: AdminEquiposComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminespacios",
      ...
      {
        path: "adminpracticas",
        component: AdminPracticasComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminpersonal",
      ...
      {
        path: "adminserviciosolicitud",
        component: SolicitudesServicioComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminserviciosasociados",
        component: ServiciosAsociadosComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminproyectos",
      ...
      {
        path: "adminsolicitudmantenimiento",
        component: SolicitudMantenimientoComponent,
        canActivate: [Nivel2Guard],
      },
      {
        path: "adminlaboratorios3",
        component: AdminLaboratorios3Component,
        canActivate: [Nivel3Guard],
      },
      {
        path: "comunicacionmasiva",
        component: ComunicacionMasivaComponent,
        canActivate: [Nivel25Guard],
      },
      {
        path: "usuarios",
      ...
      {
        path: "indicadores3",
        component: IndicadoresGraficasReportes3Component,
        canActivate: [Nivel3Guard],
      },
      {
        path: "solicitudes3",
        component: SolicitudesNivel3Component,
        canActivate: [Nivel3Guard],
      },
  ...
  { path: "", pathMatch: "full", redirectTo: "inicio" },
  {
    path: "**",
    pathMatch: "full",
    redirectTo: "principal/busquedalaboratorio",
  },
];
